...
exec_detection = ['validate_object_labels', 'pcl_from_rangeimage', 'load_image', 'bev_from_pcl', 'detect_objects', 'measure_detection_performance'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file
